...
export const FAQ: { q: string; a: string }[] = [
  {
    q: "What is TEXT-FX?",
    a: "TEXT-FX is a free generator for pure-CSS text effects. Type your text, shuffle through 144 effects across 13 categories, tune them live, then copy the CSS or export HTML, React/JSX, a PNG or a share link.",
  },
  {
    q: "Is it free?",
      ...
      <div className={styles.grid}>
        <section className={styles.col}>
          ...
          <p className={styles.p}>
            Generate, tune and export 144 pure-CSS text effects — neon, gradient, chrome, glitch, 3D,
