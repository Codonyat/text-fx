...
export const DESCRIPTION =
  "Shuffle, tune and export 85 pure-CSS text effects — neon, gradient, chrome, glitch, 3D, fire and more. Copy the CSS, HTML, React/JSX, a standalone file, a PNG or a share link. Free, no signup.";
