...
const SAMPLE = "Text";
const DESC =
  "Browse 85 free pure-CSS text effects across 13 categories — neon, gradient, chrome, glitch, 3D, fire, glass and more. Open any in the generator to tune and export.";
